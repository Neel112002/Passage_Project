...
ThemeData get lightTheme => ThemeData(
  ...
  inputDecorationTheme: const InputDecorationTheme(
    filled: true,
    isDense: true,
    // Neutral background for inputs (removes purple tint)
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(14)),
      // Neutral gray focus outline instead of purple
      borderSide: BorderSide(color: Color(0xFF94A3B8), width: 1.5),
    ),
    // Neutral icon/label colors
...
ThemeData get darkTheme => ThemeData(
  ...
  inputDecorationTheme: const InputDecorationTheme(
    ...
    focusedBorder: OutlineInputBorder(
      borderRadius: BorderRadius.all(Radius.circular(14)),
      borderSide: BorderSide(color: Color(0xFFD4BCCF), width: 1.3),
    ),
    prefixIconColor: Color(0xFFD4BCCF),
    labelStyle: TextStyle(color: Color(0xFFEAE0FF)),
  ),
  filledButtonTheme: FilledButtonThemeData(
    style: ButtonStyle(
      shape: WidgetStatePropertyAll(
